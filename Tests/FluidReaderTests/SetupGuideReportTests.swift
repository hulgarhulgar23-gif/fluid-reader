...
final class SetupGuideReportTests: XCTestCase {
    func testMarkdownIncludesShortcutsPermissionsAndUsefulCommands() {
        ...
        XCTAssertTrue(markdown.contains("Open Extensions Workspace"))
        XCTAssertTrue(markdown.contains("Open Notes Workspace"))
        XCTAssertTrue(markdown.contains("Window Settings"))
